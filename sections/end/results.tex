...
However, there is a shortcoming in terms of biological fidelity of the \ac{SNN} model by \authorsSNN{} \cite{SNN}:
...
\begin{figure}[http]
    \begin{minipage}[b]{.5\linewidth}
         ...
         \caption{Test accuracy for different learning rules (coloured lines) and different numbers of excitatory neurons from \cite{SNN}.}
         \label{img:test_acc}
    \end{minipage}
