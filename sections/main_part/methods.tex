...
\todo{vielleicht macht es auch sinn, die subsection terms hierher zu verschieben und mit einzuarbeiten}
...
\todo{concepts used in the approach by AUTHORS \cite{SNN} include ...}
...
\todo{ein satz hier wäre gut, der erklärt, warum calcium hier eine rolle spielt
  und warum die modelierung davon eine zeitabhängigkeit enthält}
